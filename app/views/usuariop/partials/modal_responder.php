	...
	<div id="modal_responder_<?php echo $row->mensaje_id ?>" class="hidden fixed inset-0 overflow-y-auto w-full h-screen bg-dark pt-24 px-2 py-5 bg-opacity-70">
		<form action="<?php echo URLROOT; ?>/usuariop/mensajes" method="post" autocomplete="off"  class="flex flex-col py-4 space-y-4 w-full mx-auto md:max-w-2xl bg-white shadow rounded-lg font-dmsans text-neutral">
			<!-- modal title -->
			...
			<div class="flex flex-col w-full px-4 space-y-2 ">
		      ...
		      <div class="w-full px-2  border-2 border-primary">
		      	<span class="text-xl text-dark">Mensaje: </span>
